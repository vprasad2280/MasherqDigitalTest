package com.test.uiAutomation.MasherqDigital.testBase;
...
import com.test.uiAutomation.MasherqDigital.customListner.WebEventListener;
...
public class TestBase {
	...
	public void loadData() throws IOException {
		File file = new File(System.getProperty("user.dir") + "/src/main/java/com/test/uiAutomation/MasherqDigital/config/config.properties");
	...
	public void selectBrowser(String browser) {
		...
		if (System.getProperty("os.name").contains("Window")) {
			...
			if (browser.equals("chrome")) {
				...
				System.out.println(System.getProperty("user.dir"));
				System.setProperty("webdriver.firefox.marionette", System.getProperty("user.dir") + "/webdriver/geckodriver");
				driver = new FirefoxDriver();
	...
	public String[][] getData(String excelName, String sheetName) {
		String path = System.getProperty("user.dir") + "/src/main/java/com/test/uiAutomation/MasherqDigital/data/" + excelName;
	...
	public void launchapp(String browser) throws IOException {
		...
		if (System.getProperty("os.name").contains("Window")) {
			if (browser.equals("chrome")) {
				...
				driver = new RemoteWebDriver(new URL(Node), cap);
				driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
				// Launch web site of specified url
				getUrl(OR.getProperty("url"));
			} else {
				throw new IllegalArgumentException("The Browser Type is Undefined");
			}
